...
Resource management in serverless computing has been an extensively studied problem, with numerous solutions proposed in the literature\todo{citation}.
...
Our analysis (\S\ref{sec:demand-analysis}) also confirms that the resource usage of a serverless function can vary up to XXX times\todo{variation} across different inputs.
Additionally, we find that this input-dependent resource usage is highly predictable, achieving an accuracy of XXX\%\todo{prediction accuracy}.
