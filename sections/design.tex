...
sandbox to scale up incrementally and avoid restarts. \junyi{repeat of overview, might consider shorten this paragraph}
...
If the node lacks sufficient idle resources for options 2) or 3), the scheduler 
