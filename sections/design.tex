...
\begin{enumerate}
    ...
    ratio remains invariant across requests of the same function.
...
\begin{algorithm}[t]
    ...
    \While{$\exists \; F_i \text{ s.t. } R[i] > 0$} \Comment{Mapping incompletement}
...
system periodically (every five minutes in our implementation) monitors the latest 
...
\begin{figure}[t]
  ...
  \vspace{-10pt}
  \caption{Monotonic acale-up scheduling workflow.}
  \vspace{-15pt}
