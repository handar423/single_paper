...
Our analysis reveals that for a substantial portion (41\%) of functions, the CV 
exceeds 50\%, indicating that these functions have a highly dispersed resource 
demand profile. A further 21\% of functions exhibit a moderate degree of variation, 
with CV values between 15\% and 50\%. Only 38\% of functions demonstrate relatively 
