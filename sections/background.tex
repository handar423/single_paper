...
profile-guided parameter tuning~\cite{aws_lambda_power_tuning,ASPLOS21:FaasCache, shahrad2020serverless, wang2018peeking, pu2019shuffling, zhang2024jolteon, JinZXZHLJ23} \todo{jolteon and ditto?}\yunshan{Done}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.95\linewidth]{figures/background/cpu_density_4funcs_134_161_170_206.pdf}
...
distribution; \junyi{does not look like a standard long-tail distribution. can we have a standard one?}\yunshan{Found} (c) a concentrated distribution; and (d) certain atypical cases 
