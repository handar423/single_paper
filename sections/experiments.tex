...
FaaSCache~\cite{tFaaSCache}—in \S\ref{sec:experiments_comparsion}. Next, 
...
of these benchmarks (see~\cite{benchmark_10} for full details). The selected benchmarks 
...
and FaaSCache~\cite{tFaaSCache}, which optimize cluster efficiency from 
