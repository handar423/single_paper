...
when the workload is larger and more diverse, the dispatching reduces the number of 
...
\begin{figure}[t]
    ...
    \caption{The average duration for \sysname to generate a dispatching plan.}
...
cluster-wide request dispatching plans under different cluster sizes. It can be observed 
...
the scheduler can generate dispatching plans promptly, even in large-scale 
...
dispatching plan generation is performed by a separate background process within 
