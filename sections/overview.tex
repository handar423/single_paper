...
The workload-splitting manager continuously collects traffic statistics, function 
...
node—executing tasks and performing vertical resource scaling. We introduce two key 
techniques in \sysname: workload-splitting-based instance placement, and 
vertical-scaling-based task scheduling.

\parabf{Workload-Splitting-based Instance Placement.} \sysname controls instance 
...
\parabf{Vertical-Scaling-based Task Scheduling}
\sysname designs the worker-level scheduling algorithm around the restart-free 
vertical pod scaling feature of Kubernetes. The scheduler maintains dual task 
...
can be vertically scaled up incrementally to meet the growing demands of successive 
