...
Kubernetes~\cite{k8s} for instance management and MinIO~\cite{MinIO} for function
data management.
...
iv) The system monitor collects real-time resource usage and per-function metrics (\eg cold-start time, execution duration, resource demand distribution). 
